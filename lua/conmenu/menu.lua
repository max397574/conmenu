            ...
            if result[1] ~= nil then
                vim.cmd(
                    "nnoremap <silent> <buffer> "
                        .. result[1]
                        .. " :lua require('conmenu').executeItemNum("
                        .. index
                        .. ")<CR>"
                )
...
function menu.executeItemNum(index)
    state.currentlySelected = index
    menu.executeItem()
end

-- Moves the selection up/down
function menu.switchItem(change)
